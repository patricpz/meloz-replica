...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen w-full bg-gradient-to-br from-secondary via-secondary to-primary overflow-hidden pt-24 md:pt-32">
      {/* Background Elements */}
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-20 right-10 w-72 h-72 bg-primary/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-20 w-72 h-72 bg-background/20 rounded-full blur-3xl" />
      </div>
          ...
          <motion.div className="text-white space-y-6 md:space-y-8">
            ...
            <motion.div variants={itemVariants}>
              <h1 className="font-display text-5xl md:text-6xl xl:text-7xl font-bold leading-tight">
                Criamos tecnologia para novos negócios digitais
              </h1>
            </motion.div>
            ...
            >
              A Meloz ajuda empresas a transformar ideias em aplicativos, plataformas e soluções financeiras que geram novas oportunidades de crescimento.
            </motion.p>
